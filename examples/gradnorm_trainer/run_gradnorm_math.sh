...
PROJECT_NAME="gradnorm-reinforce-math500"
...
python3 -m verl.trainer.main_ppo_multiobjective \
    ...
    algorithm.weighting_method=gradnorm \
    algorithm.gradnorm.gradnorm_alpha=$GRADNORM_ALPHA \
    algorithm.gradnorm.gradnorm_lr=$GRADNORM_LR \
