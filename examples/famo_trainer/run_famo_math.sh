...
PROJECT_NAME="famo-reinforce-math500"
...
# FAMO task-weight optimizer hyperparameters.
FAMO_GAMMA=1e-5
FAMO_W_LR=0.025
FAMO_EPS=1e-8
FAMO_MIN_LOSSES=null
FAMO_MIN_LOSS_MARGIN=1.0
...
python3 -m verl.trainer.main_ppo_multiobjective \
    ...
    algorithm.weighting_method=famo \
    algorithm.famo.gamma=$FAMO_GAMMA \
    algorithm.famo.w_lr=$FAMO_W_LR \
    algorithm.famo.eps=$FAMO_EPS \
    algorithm.famo.min_losses=$FAMO_MIN_LOSSES \
    algorithm.famo.min_loss_margin=$FAMO_MIN_LOSS_MARGIN \
