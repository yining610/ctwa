...
PROJECT_NAME="nash-mtl-reinforce-math500"
...
# Nash-MTL solver hyperparameters.
NASH_MTL_OPTIM_NITER=20
NASH_MTL_LR=0.1
NASH_MTL_EPS=1e-8
NASH_MTL_MAX_WEIGHT=1000.0
...
python3 -m verl.trainer.main_ppo_multiobjective \
    ...
    algorithm.weighting_method=nash_mtl \
    algorithm.nash_mtl.optim_niter=$NASH_MTL_OPTIM_NITER \
    algorithm.nash_mtl.lr=$NASH_MTL_LR \
    algorithm.nash_mtl.eps=$NASH_MTL_EPS \
    algorithm.nash_mtl.max_weight=$NASH_MTL_MAX_WEIGHT \
