...
PROJECT_NAME="lagrangian-reinforce-math500"
...
LAGRANGIAN_CONSTRAINTS="[0.9,0.9]"
...
python3 -m verl.trainer.main_ppo_multiobjective \
    ...
    algorithm.weighting_method=lagrangian \
    algorithm.lagrangian.dual_lr=$LAGRANGIAN_DUAL_LR \
    algorithm.lagrangian.constraints=$LAGRANGIAN_CONSTRAINTS \
