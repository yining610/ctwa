...
PROJECT_NAME="linear-reinforce-math500"
...
# Hyperparameters
TARGET_LAYER_IDS=null # train the whole model
COMPUTE_PER_OBJECTIVE_GRADIENT=False # for analysis purpose only
...
python3 -m verl.trainer.main_ppo_multiobjective \
    ...
    algorithm.weighting_method=multiobjective \
    ...
    actor_rollout_ref.actor.compute_per_objective_gradient=$COMPUTE_PER_OBJECTIVE_GRADIENT \
    actor_rollout_ref.actor.target_layer_ids=$TARGET_LAYER_IDS \
