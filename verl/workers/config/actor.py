...
class ActorConfig(BaseConfig):
    ...
    Args:
        ...
        norm_grad_norm (bool): Whether to normalize the gradient norm.
        gradnorm_alpha (float): GradNorm alpha (strength of balancing term).
        gradnorm_lr (float): GradNorm learning rate for task weights.
...
class FSDPActorConfig(ActorConfig):
    ...
    profiler: ProfilerConfig = field(default_factory=ProfilerConfig)
    compute_per_objective_gradient: bool = False
