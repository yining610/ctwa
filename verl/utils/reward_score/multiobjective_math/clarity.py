...
# def compute_score(solution_str, ground_truth, extra_info) -> int:

#     # Gate clarity by correctness to prevent "format-only" optimization.
#     # This encourages: be correct first, then be clear.
#     correct = bool(compute_accuracy_boxed(solution_str, ground_truth))

#     if correct and BOXED_RE.search(solution_str) and _has_step_by_step(solution_str):
#         return 1
